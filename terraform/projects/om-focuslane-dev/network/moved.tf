...
# NOT moved (kept as plain resources - see comments in psc.tf, firewall.tf,
# and cloud_dns.tf for why):
#   google_compute_global_address.aicoe_psc_address
#   google_compute_global_forwarding_rule.aicoe_psc_google_apis
