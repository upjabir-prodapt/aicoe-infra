...
moved {
  ...
  to   = module.storage.data.google_project.current
}
...
moved {
  from = google_storage_bucket.aicoe_cont_mgmt_bucket
  to   = module.storage.google_storage_bucket.buckets["vxai-cont-mgmt-app-001"]
}
