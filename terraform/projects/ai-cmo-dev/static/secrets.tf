...
resource "google_secret_manager_secret" "aicmodev_salesagent_ssl_private_key" {
  secret_id = "salesagent-ssl-private-key"
  project   = local.gcp_project_id
...
resource "google_secret_manager_secret" "aicmodev_salesagent_ssl_certificate" {
  secret_id = "salesagent-ssl-certificate"
  project   = local.gcp_project_id
