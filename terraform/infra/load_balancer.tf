...
#   name    = "${var.project}${var.envname}-ilb-translation-url-map"
#   project = "${var.project}${var.envname}"
#   region  = var.region
...
#   name    = "${var.project}${var.envname}-translation-ilb-https-proxy"
#   project = "${var.project}${var.envname}"
#   region  = var.region
...
#   name                  = "${var.project}${var.envname}-ilb-translation-fe"
#   project               = "${var.project}${var.envname}"
#   region                = var.region
...
#   secret  = "${var.project}${var.envname}-translation-ssl-certificate"
#   project = "${var.project}${var.envname}"
# }

# # Read private key from Secret Manager
# data "google_secret_manager_secret_version" "ssl_private_key" {
#   secret  = "${var.project}${var.envname}-translation-ssl-private-key"
#   project = "${var.project}${var.envname}"
# }
...
#   name   = "${var.project}${var.envname}-ilb-salesagent-be"
#   region = var.region
#   project = "${var.project}${var.envname}" 
#   load_balancing_scheme = "INTERNAL_MANAGED"
#   protocol = "HTTPS"
...
#   name                  = "${var.project}${var.envname}-serverless-neg-salesagent"
#   network_endpoint_type = "SERVERLESS"
#   region                = var.region
...
#   name    = "${var.project}${var.envname}-ilb-salesagent-url-map"
#   project = "${var.project}${var.envname}"
#   region  = var.region
...
#   name    = "${var.project}${var.envname}-ilb-salesagent-https-proxy"
#   project = "${var.project}${var.envname}"
#   region  = var.region
...
#   name                  = "${var.project}${var.envname}-ilb-salesagent-fe"
#   project               = "${var.project}${var.envname}"
#   region                = var.region
#   network               = data.terraform_remote_state.network.outputs.aicoe_network
#   subnetwork            = data.terraform_remote_state.network.outputs.aicoe_subnet_name
...
#   port_range            = 443
#   ip_address            = data.terraform_remote_state.network.outputs.aicoe_staticip_ilb_salesagent
#   load_balancing_scheme = "INTERNAL_MANAGED"
#   allow_global_access   = false
#   labels = {
#       env    = var.envname
...
#   secret  = "${var.project}${var.envname}-salesagent-ssl-certificate"
#   project = "${var.project}${var.envname}"
# }

# # Read private key from Secret Manager
# data "google_secret_manager_secret_version" "salesagent_private_key" {
#   secret  = "${var.project}${var.envname}-salesagent-ssl-private-key"
#   project = "${var.project}${var.envname}"
# }

# # SSL Certificate
# resource "google_compute_region_ssl_certificate" "aicoe_salesagent_ssl" {
#   name    = "${var.project}${var.envname}-salesagent-ssl"
#   project = "${var.project}${var.envname}"
#   region  = var.region
