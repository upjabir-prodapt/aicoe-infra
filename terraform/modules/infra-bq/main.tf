resource "google_bigquery_dataset" "aicoe_translation_dataset" {
  dataset_id               = "${var.resource_prefix}_translation_dataset"
  location                 = var.region
...
resource "google_bigquery_dataset" "aicoe_sales_agent_dataset" {
  dataset_id               = "${var.resource_prefix}_sales_agent_dataset"
  location                 = var.region
  project                  = var.gcp_project_id
...
resource "google_bigquery_dataset" "contract_management_dataset" {
  dataset_id = "${var.resource_prefix}_contract_management"
  project    = var.gcp_project_id
  location   = var.region
...
resource "google_bigquery_dataset" "aicoe_billing_dataset" {
  dataset_id               = "${var.resource_prefix}_billing_dataset"
  location                 = var.region
  project                  = var.gcp_project_id
